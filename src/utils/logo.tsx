...
export const getTitle = (currentConfig: CrosswordConfig, currentPuzzleId: PuzzleId, size: string, width: string, noBottomBorder: boolean, pencilPosition: string, withPen: boolean, withPuzzleName: boolean) => {
    const word = 'תשבצת';
    return (
    <div className="relative flex flex-row justify-between">
        <div className='border-l-[1px] border-gray-400 grid grid-flow-col'>
          ...
          {(withPuzzleName && currentConfig) && <div
            key={1000}
