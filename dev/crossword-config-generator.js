...
const rows = [
  ["סוג הכתיב במילה ספר, אולי", "__חסר"],
  ["ב-X: תגובה שהיא פופולארית יותר מהדבר שהיא מגיבה עליו", "_רטיו"],
  ["מנהיג מוסלמי", "אימאמ"],
  ["לפעמים הוא יותר מעניין מהממוצע", "חציונ"],
  ["וואלאס עשה אחת אינסופית", "מהתלה"],
];
...
const cols = [
["דמות בעלת משקל (רת)", "__אחמ"],
["דרך להגיע מהר גם כשאין דלק", "_ריצה"],
["פרח עם חלק אמצעי בולט", "חטמית"],
["בירה מזרחית", "סיאול"],
["א-לה ___ (תיאור של מאכל איטלקי)", "רומנה"],
];
// =================================================
