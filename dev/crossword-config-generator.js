...
const rows = [
["מקובל לשמור בשבילה תאריך", "חתונה"],
["תשובה משמחת לשני בירורים לגבי המלאי", "ישויש"],
["כינוי לשוער וירטואוזי", "תמנונ"],
["דוברי ספרדית עושים את ההמרה הזאת לפעמים", "וילבי"],
["הספד לאדם משעשע", "לצהיה"],
];
...
const cols = [
["זמן מה אחרי 1 מאוזן, הרבה מוצאים את עצמם מחליפים אותו", "חיתול"],
["תפתח עליו פה", "תשמיצ"],
["יש לה יכולת לרכוש פריט זול מאוד בדרום קוריאה", "וונלה"],
["״זה פעם ראשונה שלו״", "ניובי"],
["תשובה אפשרית להתלבטות בין שתי אפשרויות", "השניה"],
];
// =================================================
